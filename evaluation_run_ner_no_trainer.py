...
def main():
    ...
    if args.dataset_name is not None:
        ...
        "train": all_data["train_it"],
        "validation": all_data["val_it"],
        "test": all_data["test_it"],
    })
    else:
        data_files = {}
        if args.train_file is not None:
    ...
    if "train" in raw_datasets and raw_datasets["train"] is not None:
        column_names = raw_datasets["train"].column_names
        features = raw_datasets["train"].features
    elif "validation" in raw_datasets and raw_datasets["validation"] is not None:
        column_names = raw_datasets["validation"].column_names
        features = raw_datasets["validation"].features
    elif "test" in raw_datasets and raw_datasets["test"] is not None:
    ...
    def get_label_list(labels):
        ...
        label_list.sort()
        return label_list
        print("label _list type", type(label_list))
    ...
    if args.do_test:
        ...
        accelerator.print("Test set evaluation:", test_metric)
